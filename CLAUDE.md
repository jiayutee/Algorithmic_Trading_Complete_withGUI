...
core/
  ...
  instruments.py          # Verified catalogue (81: crypto, US stocks, ETFs, futures, indices, FX) + kind/paper-tradable rules
  yahoo_chart.py          # Direct Yahoo chart-API fallback when the yfinance library path is rate-limited (HTTP 429)
